...
#define getUuidFromBuffer(buffer) (*((char *)buffer[UUID_LEN - 2]) != '\0'?std::string(buffer,UUID_LEN):std::string(buffer))
#define getPasswordFromBuffer(buffer)  (*((char *)buffer[PASSWORD_LEN - 2]) != '\0'?std::string(buffer,PASSWORD_LEN):std::string(buffer))
#define getTokenFromBuffer(buffer) (*((char *)buffer[TOKEN_LEN - 2]) != '\0'?std::string(buffer,TOKEN_LEN):std::string(buffer))
