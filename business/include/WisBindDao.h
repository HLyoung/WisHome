...
class WisBindDao {
public:
    static bool addBind(BUS_ADDRESS_POINTER bus_address,const std::string& userUUID, const std::string& deviceUUID );
    static bool delBind(BUS_ADDRESS_POINTER bus_address,const std::string& userUUID, const std::string& deviceUUID );
	...
	static void sendBindResponse(BUS_ADDRESS_POINTER bus_address,int nCmd, int done );
};
